          ...
          <div class="w-1/4">
            ...
            >
              ...
              <div class="flex mt-3">
                <div class="w-1/4">
                  <img
                    v-if="campaign.data.user.avatar == ''"
                  ...
                  <img
                    v-else
                    :src="$axios.defaults.baseURL + '/' + campaign.data.user.avatar"
                    alt=""
                    class="w-full inline-block rounded-full"
                  />
                </div>
        ...
        <div class="flex justify-between items-center">
          <div class="w-full md:w-3/4 mr-6">
            ...
            <div class="flex progress-info mb-6">
              ...
              <div class="ml-auto font-semibold text-2xl"> Rp {{ Intl.NumberFormat().format(campaign.data.goal_amount) }}</div>
            </div>

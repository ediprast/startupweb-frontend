        ...
        <div class="block mb-2">
          <div class="w-full lg:max-w-full lg:flex mb-4" v-for="transaction in transactions.data" :key="transaction.id">
            <div
              ...
              :style="
                'background-color=#000; background-position:center; background-image: url(\'' + $axios.defaults.baseURL + '/' + transaction.campaign.image_url + '\')'
              "
            ></div>
            <div
            ...
            >
              <div>
                ...
                <p class="text-sm text-gray-600 flex items-center mb-2">
                  Rp. {{ Intl.NumberFormat().format(transaction.amount) }} &middot; {{ transaction.created_at }} &middot; {{ transaction.status }}
                </p>
              </div>
            </div>
          </div>

      ...
      <section class="container mx-auto pt-8">
        ...
        <div class="flex justify-between items-center">
          <div class="w-3/4 mr-6">
            <h3 class="text-2xl text-gray-900 mb-4">Edit Campaign Projects</h3>
          </div>
                ...
                <div class="flex flex-wrap -mx-3 mb-6">
                  ...
                  <div class="w-full px-3">
                    ...
                    <input
                      ...
                      v-model="campaign.data.short_desc"
                    />
                  </div>
                  <div class="w-full px-3">
                    <label
    ...
    async save() {
      try {
        let response = await this.$axios.$put('/api/v1/campaigns/' + this.$route.params.id, {
           title: this.campaign.data.title,
          short_description : this.campaign.data.short_desc,

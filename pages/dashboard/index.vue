        ...
        <div class="block mb-2">
          <div class="w-full lg:max-w-full lg:flex mb-4" v-for="campaign in campaigns.data" :key="campaign.id">
            <div
              ...
              :style="
                'background-color=#000; background-position:center; background-image: url(\'' + $axios.defaults.baseURL + '/' + campaign.image_url + '\')'
              "
            ></div>
            <div
            ...
            >
              <div class="mb-8">
                ...
                <p class="text-sm text-gray-600 flex items-center mb-2">
                  Rp. {{ Intl.NumberFormat().format(campaign.goal_amount) }} &middot; {{ (campaign.current_amount / campaign.goal_amount) * 100 }} %
                </p>

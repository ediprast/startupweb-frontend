  ...
  <div class="landing-page">
      ...
      <section class="container mx-auto pt-24">
        ...
        <div class="grid grid-cols-3 gap-4 mt-3 p-2">
          <div v-for="campaign in campaigns.data" :key="campaign.id" class="card-project w-full p-5 border border-gray-500 rounded-20">
            <div class="item">
              <figure class="item-image">
                <img :src="$axios.defaults.baseURL + campaign.image_url"
                  alt="" class="rounded-20 w-full"/>
              </figure>
              <div class="item-meta">
                <h4 class="text-3xl font-medium text-gray-900 mt-5">
                  {{ campaign.title }}
                </h4>
                <p class="h-12 text-md font-light text-gray-900">
                ...
                <div class="flex progress-info">
                  ...
                  <div class="ml-auto font-semibold">Rp {{ Intl.NumberFormat().format(campaign.goal_amount) }}</div>
                </div>
              </div>
              <button
                @click="$router.push({
